...
qt_root = '/usr/local/Trolltech/Qt-4.6.2/lib'
...
buildapp(
    name='MS_SVD_vis_0928.app', # what to build
    ...
    includeModules=['encodings.ascii','sip'], # list of additional Modules to force in
