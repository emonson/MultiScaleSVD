...
#
set(InstallPrefix "/Users/emonson/Programming/Python/VTK/QtTests/build")
...
execute_process(WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
                COMMAND python2.6 make_qtlistview_app.py build
                )

set(bundle "${InstallPrefix}/QtListView_0211.app")
...
fixup_bundle(
  "${bundle}"
  "${VTK_Python_Libs};${PyQt_Python_Libs}"
  "${libs_path}"
  )
